...
public class CreateElementDialog extends JDialog
{
    ...
    private static CreateElementDialog dialog;
    JLabel file, folder, drive;
    ...
    public static void display(MainFrame parent)
    {
        ...
        if (FileManager.getCurrentTarget() == OperationManager.getConfiguration())
        {
            dialog.folder.setEnabled(false);
            dialog.file.setEnabled(false);
        }
        else
            dialog.drive.setEnabled(false);
